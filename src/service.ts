...
import type { LibraryId, LibraryInfo, LibraryDetails, AreaInfo, AreaDetails, SeatInfo, SeatDetails, AreaId, SeatId, DatedLibraryAvailability, LibraryAvailability, AreaAvailability, SeatAvailability } from "./types.js";
